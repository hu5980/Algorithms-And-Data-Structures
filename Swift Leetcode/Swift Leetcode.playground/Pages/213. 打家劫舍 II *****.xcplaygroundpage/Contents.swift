...
/*:
 ...
 [打家劫舍 2](https://leetcode-cn.com/problems/house-robber-ii)
...
class Solution {
    ...
    func rob(_ nums: [Int]) -> Int {
        ...
        return max(dpRobTol(Array.init(nums[1...nums.count-1]), robTotal: &robTotal), dpRobTol(Array.init(nums[0...nums.count-2]), robTotal: &robTotal))
    }
}
